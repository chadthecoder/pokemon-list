  ...
  return (<>
    <form className='p-10 w-[500px] relative'>
        <div className="relative">
            <textarea placeholder='Search by Name or ID...' maxLength={15} className='flex flex-col resize-none h-14 w-full p-4 rounded-full bg-slate-800 text-white' onChange={(e) => setSearchText(e.target.value)}/>
